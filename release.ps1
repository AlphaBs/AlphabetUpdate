...
Copy-Item .\AlphabetUpdate.Client\bin\Release\AlphabetUpdate.Client.$ver.nupkg .\release
Copy-Item .\AlphabetUpdate.Common\bin\Release\AlphabetUpdate.Common.$ver.nupkg .\release
Copy-Item .\AuthYouClient\bin\Release\AuthYouclient.$ver.nupkg .\release
